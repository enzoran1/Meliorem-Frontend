...
const ButtonArrowOutlineWhite = () => (
  <div className={styles.ButtonArrowOutlineWhite} data-testid="ButtonArrowOutlineWhite">
...
ButtonArrowOutlineWhite.propTypes = {};

ButtonArrowOutlineWhite.defaultProps = {};

export default ButtonArrowOutlineWhite;

...
export const getAllWithPageQuizPart = (token,elementCount,actualPage,success,error) => {
    return UtilsAPI.getAllWithPage('quiz-part',token,elementCount,actualPage,success,error);
}
